...
$this->registerJsFile('/app-assets/vendors/js/extensions/dropzone.min.js',
    ['depends' => ['frontend\assets\AppAsset'
        , 'frontend\assets\AppAsset']
    ]);
...
$this->registerJsFile('/app-assets/js/scripts/pages/page-account-settings.js',
    ['depends' => ['frontend\assets\AppAsset'
        , 'frontend\assets\AppAsset']
    ]);
...
$this->registerCssFile("@web/app-assets/vendors/css/forms/select/select2.min.css",
    ['rel' => 'stylesheet',

        'depends'=> ['frontend\assets\AppAsset']]);

$this->registerCssFile("@web/app-assets/vendors/css/pickers/pickadate/pickadate.css",
    ['rel' => 'stylesheet',

        'depends'=> ['frontend\assets\AppAsset']]);
$this->registerCssFile("@web/app-assets/css/plugins/forms/validation/form-validation.css",
    ['rel' => 'stylesheet',
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="active nav-item"><a href="page-account-settings.html"><i class="menu-livicon" data-icon="wrench"></i><span class="menu-title" data-i18n="Account Settings">Account Settings</span></a>
            </li>
