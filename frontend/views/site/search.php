...
$this->registerJsFile('/app-assets/js/scripts/pages/page-search.js',
    ['depends' => ['frontend\assets\AppAsset'
        , 'frontend\assets\AppAsset']
    ]);
...
$this->registerCssFile("@web/app-assets/css/plugins/extensions/swiper.css",
    ['rel' => 'stylesheet',
        ...
        'depends'=> ['frontend\assets\AppAsset']]);
$this->registerCssFile("@web/app-assets/css/pages/search.css",
    ['rel' => 'stylesheet',
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="active nav-item"><a href="page-search.html"><i class="menu-livicon" data-icon="search"></i><span class="menu-title" data-i18n="Search">Search</span></a>
            </li>
        ...
        <div class="content-header row">
            <div class="content-header-left col-12 mb-2 mt-1">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h5 class="content-header-title float-left pr-1 mb-0">Search</h5>
                ...
                <div class="search-bar">
                    ...
                    <form>
                        <fieldset class="search-input form-group position-relative">
                            <input type="search" class="form-control rounded-right form-control-lg shadow pl-2" id="searchbar" placeholder="Search">
                    ...
                    <div class="col-12">
                        ...
                        <ul class="nav nav-tabs py-1" role="tablist">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="tab" aria-haspopup="true" aria-expanded="false">
                                    <i class="bx bx-cog"></i>
                                ...
                                <ul class="list-unstyled">
                                        ...
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title cursor-pointer">
                                                    <a href="https://pixinvent.com/demo/vuexy-html-admin-dashboard-template/html/ltr/vertical-menu-template/page-search.html" target="_blank">
                                            ...
                                            <div class="card-footer border-top d-flex justify-content-between">
                                                <small class="text-truncate">
                                                    <a href="https://themeforest.net/item/vuexy-vuejs-admin-dashboard-template/23328599" class="success darken-4" target="_blank">
                                    ...
                                    <li class="media-list">
                                        <div class="media mb-1">
                                            <a href="https://twitter.com/pixinvents" class="pr-1" target="_blank">
                                                <img src="/app-assets/images/pages/pixinvent.jpg" alt="pixinvent" class="rounded-circle" height="50" width="50">
                                            </a>
                                            <div class="media-body d-sm-flex justify-content-between align-items-center">
                                                <div class="media-text">
                                                    ...
                                                    <a href="https://twitter.com/pixinvents" class="success darken-4" target="_blank">https://twitter.com/pixinvents
                                                    </a>
                                                </div>
                                    ...
                                    <li>
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title cursor-pointer">
                                                    <a href="https://dribbble.com/shots/6065222-vuexy-Vuejs-Vuejs-Admin-Dashboard-Template" target="_blank">
                                            ...
                                            <div class="card-footer border-top d-flex justify-content-between">
                                                <small class="text-truncate">
                                                    <a href="https://dribbble.com/shots/6065222-vuexy-Vuejs-Vuejs-Admin-Dashboard-Template" class="success darken-4 " target="_blank">
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide rounded">
                                            <div class="slide-content">
                                                <a href="https://www.youtube.com/watch?time_continue=8&v=Y2zBqYEJCdw" target="_blank" class="font-medium-1">
                                                    <div class="position-relative mb-1">
                                                        <img src="/app-assets/images/slider/apex.jpg" alt="apex" class="card-img">
                                        ...
                                        <div class="swiper-slide rounded">
                                            <div class="slide-content">
                                                <a href="https://www.youtube.com/watch?v=ik9Nf7idrXY" class="font-medium-1" target="_blank">
                                                    <div class="position-relative mb-1">
                                                        <img src="/app-assets/images/slider/materialize.jpg" alt="materialize" class="card-img">
                                                        <div class="card-img-overlay overlay-dark rounded">
                                                            <div class="d-flex justify-content-center align-items-center h-100">
                                                                <i class="bx bx-play-circle font-large-2 text-center"></i>
                                                            </div>
                                        ...
                                        <div class="swiper-slide rounded">
                                            <div class="slide-content">
                                                <a href="https://www.youtube.com/watch?v=e7QTyzx-lYE" class="font-medium-1" target="_blank">
                                                    <div class="position-relative mb-1">
                                                        <img src="/app-assets/images/slider/modern.jpg" alt="modern" class="card-img">
                                                        <div class="card-img-overlay overlay-dark rounded">
                                                            <div class="d-flex justify-content-center align-items-center h-100">
                                                                <i class="bx bx-play-circle font-large-2 text-center"></i>
                                                            </div>
                                        ...
                                        <div class="swiper-slide rounded">
                                            <div class="slide-content">
                                                <a href="https://www.youtube.com/watch?v=4irB7FBO3j8" class="font-medium-1" target="_blank">
                                                    <div class="position-relative mb-1">
                                                        <img src="/app-assets/images/slider/stack.jpg" alt="stack" class="card-img">
                                                        <div class="card-img-overlay overlay-dark rounded">
                                                            <div class="d-flex justify-content-center align-items-center h-100">
                                                                <i class="bx bx-play-circle font-large-2 text-center"></i>
                                                            </div>
                                        ...
                                        <div class="swiper-slide rounded">
                                            <div class="slide-content">
                                                <a href="https://www.youtube.com/watch?v=xBa6ma7F_VA" target="_blank" class="font-medium-1">
                                                    <div class="position-relative mb-1">
                                                        <img src="/app-assets/images/slider/vuesax.jpg" alt="vuexy" class="card-img">
                                                        <div class="card-img-overlay overlay-dark rounded">
                                                            <div class="d-flex justify-content-center align-items-center h-100">
                                                                <i class="bx bx-play-circle font-large-2 text-center"></i>
                                                            </div>
                                ...
                                <ul class="list-unstyled">
                                    <li>
                                        <div class="card">
                                            ...
                                            <div class="card-footer border-top d-flex justify-content-between">
                                                <small class="text-truncate">
                                                    <a href="https://getbootstrap.com/docs/4.1/getting-started/introduction/" class="success darken-4" target="_blank">
                                    ...
                                    <li>
                                        <div class="card">
                                            <div class="card-header">
                                                <h4 class="card-title cursor-pointer">
                                                    <a href="https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/documentation/" target="_blank">
                                            ...
                                            <div class="card-footer border-top d-flex justify-content-between">
                                                <small class="text-truncate">
                                                    <a href="https://pixinvent.com/demo/vuexy-vuejs-admin-dashboard-template/documentation/" class="success darken-4" target="_blank">
                                    ...
                                    <li>
                                        <div class="card">
                                            ...
                                            <div class="card-content">
                                                <div class="card-body">
                                                    <p class="card-text">
                                                        FREE SKETCH, ADOBE XD & FIGMA FILE INCLUDED Vuexy – Vuejs Admin Dashboard Template – is the most
                                            ...
                                            <div class="card-footer border-top d-flex justify-content-between">
                                                <small class="text-truncate">
                                                    <a href="https://www.uplabs.com/posts/vuexy-vuejs-vuejs-admin-dashboard-template" class="success darken-4" target="_blank">
                                        ...
                                        <div class="card-body">
                                            <div class="row text-center">
                                                ...
                                                <div class="col-lg-2 col-sm-4 col-6">
                                                    <div class="suggestion mb-lg-0 mb-1">
                                                        <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875" target="_blank">
                                                            <img src="/app-assets/images/pages/modern-thumbnail.png" alt="Image description" height="40" width="40">
                                                ...
                                                <div class="col-lg-2 col-sm-4 col-6">
                                                    <div class="suggestion mb-lg-0 mb-1">
                                                        <a href="https://themeforest.net/item/apex-angular-4-bootstrap-admin-template/20774875" target="_blank">
                                                            <img src="/app-assets/images/pages/thumbnail.png" alt="Image description" height="40" width="40">
                        ...
                        <div class="card box-search">
                            <div class="card-body">
                                ...
                                <p class="mt-1">
                                    ...
                                    <a href="https://pixinvent.com/demo/vuexy-html-admin-dashboard-template/landing/" class="align-middle" target="_blank">
                                        View on Themeforest
                                    </a>
                                </p>
                                <p class="card-text">
