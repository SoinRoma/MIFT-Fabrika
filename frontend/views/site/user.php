...
$this->registerJsFile('/app-assets/js/scripts/pages/page-user-profile.js',
    ['depends' => ['frontend\assets\AppAsset'
        , 'frontend\assets\AppAsset']
    ]);
...
$this->registerCssFile("@web/app-assets/css/pages/page-user-profile.css",
    ['rel' => 'stylesheet',
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="lines">
            ...
            <li class="active nav-item"><a href="page-user-profile.html"><i class="menu-livicon" data-icon="user"></i><span class="menu-title" data-i18n="User Profile">User Profile</span></a>
            </li>
